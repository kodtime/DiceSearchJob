...
public class DiceJobSearch {
	...
	public static void main(String[] args)  {
		...
		*/
		...
		String[] searchwords= {"sdet","test engineer","front-end developer","java developer","block chain developer","data scientist","project manager"
				,"program manager","php developer","web developer", "software developer","software engineer"};
